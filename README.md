...
| `training/aipromptengineer/` | **AI Prompt Engineer** (recommended 3–6 weeks): how LLMs work, prompt fundamentals, advanced techniques, structured output, system prompts, RAG grounding, tools & agents, evaluation & safety — ending in The Prompt Engineer Portfolio. Word: `AI-Prompt-Engineer-Training-Guide.docx` |
| `training/lowcodebuilder/` | **Low-Code App Builder** (recommended 6–9 weeks): low-code thinking, data & data sources, building UIs, logic & workflows, integrations & APIs, automation, deployment — ending in The Low-Code Portfolio. Word: `Low-Code-App-Builder-Training-Guide.docx` |
| `training/gitgithub/` | **Git & GitHub** (recommended 4–6 weeks): setup, the three states, branching & merging, undoing & recovery, the GitHub platform, pull requests & collaboration, advanced Git, GitHub Actions — ending in The Git Portfolio. Word: `Git-GitHub-Training-Guide.docx` |
| `training/nodejs/` | **Node.js** (recommended 5–8 weeks): the runtime & event loop, modules & npm, async JavaScript, core APIs, Express APIs, databases, authentication & security, errors/testing/deployment — ending in The Node API. Word: `Node-js-Training-Guide.docx` |
| `training/javascript/` | **JavaScript** (recommended 5–8 weeks): foundations, control flow & functions, data structures, modern JavaScript, the DOM, events & forms, async & APIs, debugging & clean code — ending in The JavaScript Portfolio. Word: `JavaScript-Training-Guide.docx` |
| `training/react/` | **React** (recommended 5–8 weeks): thinking in components, props, state & hooks, events & forms, lists & conditionals, effects & data fetching, state management & context, routing/structure/deployment — ending in The React App. Word: `React-Training-Guide.docx` |
| `training/aiagentcreation/` | **AI Agent Creation** (recommended 4–6 weeks): agents & the landscape, prompting foundations, tools & function calling, the agent loop, knowledge & memory (RAG), building agents, multi-agent workflows, guardrails/evaluation/safety — ending in The Agent Portfolio. Word: `AI-Agent-Creation-Training-Guide.docx` |
| `training/cloudflare/` | **Cloudflare** (recommended 4–6 weeks): how the web & Cloudflare work, DNS, CDN & caching, security & protection, rules & configuration, Pages, Workers at the edge, storage/data/Zero Trust — ending in The Cloudflare Portfolio. Word: `Cloudflare-Training-Guide.docx` |
| `training/microsoftoffice/` | **Microsoft Office** (recommended 4–6 weeks): working smart, professional Word, Excel foundations, analysis & power functions, PivotTables & dashboards, compelling PowerPoint, Outlook & collaboration, Copilot & automation — ending in The Office Portfolio. Word: `Microsoft-Office-Training-Guide.docx` |
| `training/googleworkspace/` | **Google Workspace** (recommended 4–6 weeks): Drive & collaboration, Docs, Sheets foundations, analysis & power functions, pivot tables & dashboards, Slides, Gmail/Calendar/Meet, Gemini AI & automation — ending in The Workspace Portfolio. Word: `Google-Workspace-Training-Guide.docx` |
| `training/timemanagement/` | **Time Management** (recommended 3–5 weeks): where your time goes, goals & priorities, capturing & organising tasks, planning, focus & beating distraction, beating procrastination, habits & routines, energy/balance/burnout — ending in Your Productivity System. Word: `Time-Management-Training-Guide.docx` |
...
- **Live UX.** The "Courses" nav link is a "Career & Skill Tracks" dropdown (six category sub-items that switch the active category tab + scroll to the grid, plus an "AI Made Simple ↗" link out to aimadesimpleschool.com). The category tabs (Tech & Development, Design & Creative, …) render as a single auto-rolling marquee cylinder (left→right, hover-to-pause); the course cards sit in a static responsive grid; cards, pillars, price cards and buttons perform a slow tumble on hover/touch; all motion honours `prefers-reduced-motion`.
