...
window.MS = (function () {
  ...
  const CATALOGUE = [
    ...
    },
    {
      ...
      tracks: [
        ...
        { slug: "ai-prompt-engineer", name: "AI Prompt Engineer", courses: "12 guided parts", duration: "3–6 weeks", featured: true, training: "training/aipromptengineer/index.html",
          blurb: "Get reliable, high-quality results from AI — how LLMs work, prompt fundamentals, advanced techniques (few-shot, reasoning, decomposition), structured output, system prompts, RAG grounding, tools & agents, and evaluation & safety, ending in The Prompt Engineer Portfolio, with full training pages inside." },
        { slug: "lowcode-builder",    name: "Low-Code App Builder", courses: "12 guided parts", duration: "6–9 weeks", featured: true, training: "training/lowcodebuilder/index.html",
          blurb: "Build real applications fast with low-code — the builder mindset, data & data sources, building UIs, logic & workflows, connecting data & APIs, integrations & automation, and deployment, ending in The Low-Code Portfolio of real apps, with full training pages inside." }
      ]
    },
    {
      id: "skills", label: "Skills",
      tracks: [
        { slug: "git-github", name: "Git & GitHub", courses: "12 guided parts", duration: "4–6 weeks", featured: true, training: "training/gitgithub/index.html",
          blurb: "Master version control & collaboration — setup, the three states, branching & merging, undoing & recovery, the GitHub platform, pull requests & code review, advanced Git (rebase, cherry-pick, stash), and CI/CD with GitHub Actions, ending in The Git Portfolio (a professional GitHub presence), with full training pages inside." },
        { slug: "node-js", name: "Node.js", courses: "12 guided parts", duration: "5–8 weeks", featured: true, training: "training/nodejs/index.html",
          blurb: "Build backends in JavaScript — the runtime & event loop, modules & npm, async JavaScript, core APIs, building REST APIs with Express, databases (SQL & NoSQL), authentication & security, and errors, testing & deployment, ending in The Node API (a complete, deployed backend), with full training pages inside." },
        { slug: "react", name: "React", courses: "12 guided parts", duration: "5–8 weeks", featured: true, training: "training/react/index.html",
          blurb: "Build modern, interactive UIs — thinking in components, props, state & hooks, events & controlled forms, rendering lists & conditionals, effects & data fetching, state management & context, and routing, structure & deployment, ending in The React App (a deployed application), with full training pages inside." },
        { slug: "javascript", name: "JavaScript", courses: "12 guided parts", duration: "5–8 weeks", featured: true, training: "training/javascript/index.html",
          blurb: "The language of the web — foundations, control flow & functions, data structures, modern JavaScript (ES2015+), the DOM & interactivity, events & forms, async JavaScript & APIs, and debugging & clean code, ending in The JavaScript Portfolio of interactive web projects (the foundation for React & Node), with full training pages inside." },
        { slug: "ai-agent-creation", name: "AI Agent Creation", courses: "12 guided parts", duration: "4–6 weeks", featured: true, training: "training/aiagentcreation/index.html",
          blurb: "Build AI that takes action — agents & the 2026 landscape, prompting foundations, tools & function calling, the agent loop, knowledge & memory (RAG), building agents (no-code & frameworks), multi-agent workflows, and guardrails, evaluation & safety, ending in The Agent Portfolio of real, reliable agents, with full training pages inside." },
        { slug: "cloudflare", name: "Cloudflare", courses: "12 guided parts", duration: "4–6 weeks", featured: true, training: "training/cloudflare/index.html",
          blurb: "Make sites fast, safe & serverless — how the web & Cloudflare work, DNS, CDN & caching, security & protection, rules & configuration, the developer platform (Pages), Workers at the edge, and storage, data & Zero Trust, ending in The Cloudflare Portfolio, with full training pages inside." },
        { slug: "microsoft-office", name: "Microsoft Office", courses: "12 guided parts", duration: "4–6 weeks", featured: true, training: "training/microsoftoffice/index.html",
          blurb: "Real workplace proficiency — working smart, professional Word documents, Excel foundations, analysis & power functions, PivotTables & dashboards, compelling PowerPoint, Outlook & collaboration, and Copilot & automation, ending in The Office Portfolio (especially strong Excel), with full training pages inside." },
        { slug: "google-workspace", name: "Google Workspace", courses: "12 guided parts", duration: "4–6 weeks", featured: true, training: "training/googleworkspace/index.html",
          blurb: "The cloud-collaboration suite remote teams run on — Drive & collaboration, Google Docs, Sheets foundations, analysis & power functions, pivot tables & dashboards, Google Slides, Gmail, Calendar & Meet, and Gemini AI & automation, ending in The Workspace Portfolio (especially strong Sheets), with full training pages inside." },
        { slug: "time-management", name: "Time Management", courses: "12 guided parts", duration: "3–5 weeks", featured: true, training: "training/timemanagement/index.html",
          blurb: "The meta-skill for remote work — where your time goes, goals & priorities, capturing & organising tasks, planning, focus & beating distraction, beating procrastination, habits & routines, and energy, balance & avoiding burnout, ending in Your Productivity System, with full training pages inside." }
      ]
    }
  ];
  ...
  const SYLLABI = {
    "ai-prompt-engineer": {
      ...
      subtitle: "The complete AI prompt-engineering training \u2014 how LLMs work, prompt fundamentals, advanced techniques, structured output, system prompts, RAG grounding, tools & agents, and evaluation & safety. Ends in The Prompt Engineer Portfolio. Recommended duration: 3\u20136 weeks.",
      training: "training/aipromptengineer/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 AI, LLMs & the Role", "How models work, the field in 2026", "An AI & role brief"],
        ["1", "Part 2 \u00b7 Prompting Fundamentals", "Clarity, structure, the anatomy of a prompt", "Engineered prompts"],
        ["1\u20132", "Part 3 \u00b7 Advanced Techniques", "Few-shot, chain-of-thought, roles, formats", "A technique toolkit"],
        ["2", "Part 4 \u00b7 System Prompts & Reliability", "System instructions, consistency, guardrails", "A reliable prompt system"],
        ["2\u20133", "Part 5 \u00b7 Context, Data & RAG", "Giving models the right knowledge", "A context/RAG-style solution"],
        ["3", "Part 6 \u00b7 Tools, Function Calling & Agents", "Models that act, multi-step & agentic workflows", "A tool-using/agentic workflow"],
        ["3\u20134", "Part 7 \u00b7 Evaluation & Improvement", "Testing, measuring, and improving AI outputs", "An evaluation + improvement"],
        ["4\u20135", "Part 8 \u00b7 Safety, Ethics & Production", "Accuracy, safety, bias, privacy, shipping", "A safe, production-minded solution"],
        ["5\u20136", "Part 9 \u00b7 Capstone & Career", "The Prompt Engineering Portfolio, the job hunt", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What an AI Prompt Engineer Actually Does (in 2026)", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (3\u20136 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 AI, LLMs & the Role",
          items: ["1.1 How LLMs Work (Enough to Prompt Well)", "1.2 The Field in 2026: Beyond 'Just Prompts'", "1.3 The Prompt Engineer's Mindset (Practical)"] },
        { title: "Part 2 \u2014 Prompting Fundamentals",
          items: ["2.1 Clarity and Specificity: The Whole Ballgame", "2.2 The Anatomy of a Strong Prompt (Practical)", "2.3 Iteration: The Empirical Craft"] },
        { title: "Part 3 \u2014 Advanced Techniques",
          items: ["3.1 Techniques That Reliably Improve Output", "3.2 The Core Techniques (Practical)", "3.3 Combining Techniques for Hard Tasks"] },
        { title: "Part 4 \u2014 System Prompts & Reliability",
          items: ["4.1 From One-Off Prompts to Reliable Systems", "4.2 System Prompts and Consistency (Practical)", "4.3 Engineering for Dependability"] },
        { title: "Part 5 \u2014 Context, Data & RAG",
          items: ["5.1 Why Context Is King", "5.2 Providing Context and RAG (Practical)", "5.3 Grounded, Trustworthy AI"] },
        { title: "Part 6 \u2014 Tools, Function Calling & Agents",
          items: ["6.1 From Answering to Acting", "6.2 Tool Use and Agentic Workflows (Practical)", "6.3 Designing Capable, Controlled AI Systems"] },
        { title: "Part 7 \u2014 Evaluation & Improvement",
          items: ["7.1 You Can't Improve What You Don't Measure", "7.2 Evaluating and Improving (Practical)", "7.3 Engineering, Not Guessing"] },
        { title: "Part 8 \u2014 Safety, Ethics & Production",
          items: ["8.1 Responsible AI Is Non-Negotiable", "8.2 Safety, Ethics, and Shipping (Practical)", "8.3 Trustworthy, Deployable AI"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Prompt Engineering Portfolio", "9.2 The Remote Job Hunt (2026)"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Models & Prompting on One Page", "A.2 Techniques & Reliability on One Page", "A.3 Context, Tools, Eval & Safety on One Page"] },
    ...
    "lowcode-builder": {
      ...
      subtitle: "The complete low-code app-building training \u2014 low-code thinking, data & data sources, building UIs, logic & workflows, integrations & APIs, automation, and deployment. Ends in The Low-Code Portfolio of real apps. Recommended duration: 6\u20139 weeks.",
      training: "training/lowcodebuilder/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Low-Code & the Builder", "What low-code is, the platforms, the role", "An app concept + plan"],
        ["1\u20132", "Part 2 \u00b7 Data & Data Sources", "Data modelling, databases, connecting data", "An app data model"],
        ["2\u20133", "Part 3 \u00b7 Building the App UI", "Screens, components, forms, data display", "A working app interface"],
        ["3\u20134", "Part 4 \u00b7 Logic, Workflows & Automation", "Logic, formulas, automated workflows", "A working app with logic"],
        ["4\u20135", "Part 5 \u00b7 Internal Tools & Dashboards", "Admin panels, dashboards, ops tools", "An internal tool/dashboard"],
        ["5\u20136", "Part 6 \u00b7 Integrations & APIs", "Connecting services, APIs, the ecosystem", "An integrated app"],
        ["6", "Part 7 \u00b7 Users, Access & Security", "Auth, roles, permissions, data security", "A secure, multi-user app"],
        ["6\u20137", "Part 8 \u00b7 Deploy, Maintain & Govern", "Shipping, maintaining, governance, scale", "A deployed, maintainable app"],
        ["7\u20138", "Part 9 \u00b7 Capstone & Career", "The Low-Code Portfolio, the job hunt", "Portfolio apps + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What a Low-Code App Builder Actually Does (in 2026)", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (6\u20139 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Low-Code & the Builder",
          items: ["1.1 Low-Code, No-Code, and Traditional Code", "1.2 The Platforms and the 'Citizen Developer' Role", "1.3 The Builder Mindset (Practical)"] },
        { title: "Part 2 \u2014 Data & Data Sources",
          items: ["2.1 Data Is the Foundation (and Often Already Exists)", "2.2 Modelling and Connecting Data (Practical)", "2.3 Designing Around Real Business Data"] },
        { title: "Part 3 \u2014 Building the App UI",
          items: ["3.1 The Interface Where Work Gets Done", "3.2 Components, Forms, and Data Display (Practical)", "3.3 Usable Tools People Actually Adopt"] },
        { title: "Part 4 \u2014 Logic, Workflows & Automation",
          items: ["4.1 Logic Makes It an Application", "4.2 Actions, Workflows, and Formulas (Practical)", "4.3 Automating Real Business Processes"] },
        { title: "Part 5 \u2014 Internal Tools & Dashboards",
          items: ["5.1 The Apps Every Business Needs", "5.2 Building Internal Tools and Dashboards (Practical)", "5.3 The Most Employable Low-Code Skill"] },
        { title: "Part 6 \u2014 Integrations & APIs",
          items: ["6.1 Connect, Don't Rebuild", "6.2 Connectors, APIs, and Orchestration (Practical)", "6.3 Apps at the Centre of the Workflow"] },
        { title: "Part 7 \u2014 Users, Access & Security",
          items: ["7.1 Business Apps Have Users and Sensitive Data", "7.2 Auth, Roles, and Permissions (Practical)", "7.3 Professional, Trustworthy Apps"] },
        { title: "Part 8 \u2014 Deploy, Maintain & Govern",
          items: ["8.1 From Built to In-Use (and Maintained)", "8.2 Deploying, Maintaining, and Governing (Practical)", "8.3 Building Apps That Last"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Low-Code Portfolio", "9.2 The Remote Job Hunt (2026)"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 The Field & Data on One Page", "A.2 UI & Logic on One Page", "A.3 Integration, Security & Deploy on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "git-github": {
      title: "Git & GitHub",
      subtitle: "The complete Git & GitHub training \u2014 setup, the three states, branching & merging, undoing & recovery, the GitHub platform, pull requests & collaboration, advanced Git, and GitHub Actions. Ends in The Git Portfolio. Recommended duration: 4\u20136 weeks.",
      training: "training/gitgithub/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Setup & Foundation", "Install, configure, GitHub account, SSH", "A configured environment + first repo"],
        ["1\u20132", "Part 2 \u00b7 Core Git \u2014 The Three States", "Commits, the staging area, the mental model", "A repo with clean commit history"],
        ["2", "Part 3 \u00b7 Branching & Merging", "Branches, merging, resolving conflicts", "Branched, merged work"],
        ["2\u20133", "Part 4 \u00b7 Undoing & Time Travel", "Restore, reset, revert, recovering safely", "Confident recovery from mistakes"],
        ["3", "Part 5 \u00b7 GitHub Platform", "Repos, issues, README, GitHub Pages", "A documented repo + a live page"],
        ["3\u20134", "Part 6 \u00b7 Collaboration & Pull Requests", "Forks, PRs, code review, branch protection", "A pull request + a review"],
        ["4", "Part 7 \u00b7 Advanced Git", "Rebase, cherry-pick, stash, reflog, hooks", "Advanced history operations"],
        ["4\u20135", "Part 8 \u00b7 DevOps & GitHub Actions", "CI/CD basics, Actions, secrets, releases", "A working Actions workflow"],
        ["5", "Part 9 \u00b7 Capstone & Career", "The Git Portfolio, the profile, the workflow", "A professional GitHub profile"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 Why Git & GitHub Are Non-Negotiable", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (4\u20136 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Setup & Foundation",
          items: ["1.1 What Git Is (and Isn't)", "1.2 Install, Configure, and Connect (Practical)", "1.3 The Repository and the Working Directory"] },
        { title: "Part 2 \u2014 Core Git: The Three States",
          items: ["2.1 The Three States: Git's Core Concept", "2.2 The Everyday Workflow (Practical)", "2.3 Committing Well"] },
        { title: "Part 3 \u2014 Branching & Merging",
          items: ["3.1 Why Branches Are the Whole Point", "3.2 Branching, Merging, and Conflicts (Practical)", "3.3 Branching Strategies and Clean Integration"] },
        { title: "Part 4 \u2014 Undoing & Time Travel",
          items: ["4.1 Git Means You Can Always Undo", "4.2 The Undo Toolkit (Practical)", "4.3 Working Fearlessly"] },
        { title: "Part 5 \u2014 The GitHub Platform",
          items: ["5.1 GitHub: Where Your Work Lives and Shines", "5.2 READMEs, Issues, and GitHub Pages (Practical)", "5.3 Presenting Your Work Professionally"] },
        { title: "Part 6 \u2014 Collaboration & Pull Requests",
          items: ["6.1 The Pull Request: The Heart of Collaboration", "6.2 Forks, PRs, and Code Review (Practical)", "6.3 Quality, Protection, and Open Source"] },
        { title: "Part 7 \u2014 Advanced Git",
          items: ["7.1 Power Tools for a Clean, Controlled History", "7.2 Rebase, Cherry-Pick, and Stash (Practical)", "7.3 Commanding Git"] },
        { title: "Part 8 \u2014 DevOps & GitHub Actions",
          items: ["8.1 Automation: From Commit to Deployment", "8.2 Building a Workflow (Practical)", "8.3 Shipping Like a Professional"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Git Portfolio", "9.2 Git in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Setup & Core Workflow on One Page", "A.2 Branching & Undoing on One Page", "A.3 GitHub, Collaboration & Automation on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "node-js": {
      title: "Node.js",
      subtitle: "The complete Node.js training \u2014 the runtime & event loop, modules & npm, async JavaScript, core APIs, building APIs with Express, databases, authentication & security, and errors, testing & deployment. Ends in The Node API. Recommended duration: 5\u20138 weeks.",
      training: "training/nodejs/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Node Fundamentals", "The runtime, running JS, the event loop, npm", "A configured Node project"],
        ["1\u20132", "Part 2 \u00b7 Modules, npm & the Ecosystem", "Modules (ESM), packages, package.json", "A modular project with dependencies"],
        ["2", "Part 3 \u00b7 Async JavaScript in Node", "Callbacks, promises, async/await, the event loop", "Confident async code"],
        ["2\u20133", "Part 4 \u00b7 The File System & Core APIs", "fs, path, process, streams, built-in modules", "A working CLI/file tool"],
        ["3\u20134", "Part 5 \u00b7 Building HTTP Servers & APIs", "HTTP, Express, routing, REST principles", "A REST API"],
        ["4\u20135", "Part 6 \u00b7 Databases", "SQL & NoSQL, connecting, CRUD, an ORM/ODM", "An API backed by a database"],
        ["5", "Part 7 \u00b7 Authentication & Security", "Auth, JWT/sessions, hashing, validation, security", "A secured, authenticated API"],
        ["5\u20136", "Part 8 \u00b7 Errors, Testing & Deployment", "Error handling, testing, env vars, deploying", "A tested, deployed API"],
        ["6\u20137", "Part 9 \u00b7 Capstone & Career", "The Node API, the portfolio, the job hunt", "A portfolio-ready backend"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What Node.js Is and Why It Matters", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (5\u20138 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Node Fundamentals",
          items: ["1.1 JavaScript on the Server", "1.2 The Event Loop and Non-Blocking I/O", "1.3 Running Node and Setting Up a Project (Practical)", "1.4 The Node Mental Model"] },
        { title: "Part 2 \u2014 Modules, npm & the Ecosystem",
          items: ["2.1 Composing Software from Modules", "2.2 Modules and Packages (Practical)", "2.3 The Ecosystem as a Superpower"] },
        { title: "Part 3 \u2014 Async JavaScript in Node",
          items: ["3.1 Why Everything Is Async", "3.2 Promises and Async/Await (Practical)", "3.3 Thinking Asynchronously"] },
        { title: "Part 4 \u2014 The File System & Core APIs",
          items: ["4.1 What Node Can Do That Browsers Can't", "4.2 File System, Paths, and Streams (Practical)", "4.3 Building Real Tools"] },
        { title: "Part 5 \u2014 Building HTTP Servers & APIs",
          items: ["5.1 The Backend's Job: Serving Requests", "5.2 Express, Routing, and REST (Practical)", "5.3 Designing Good APIs"] },
        { title: "Part 6 \u2014 Databases",
          items: ["6.1 Persisting Data", "6.2 Connecting and CRUD (Practical)", "6.3 Data Modelling and a Real Backend"] },
        { title: "Part 7 \u2014 Authentication & Security",
          items: ["7.1 The Backend Is Responsible for Security", "7.2 Authentication and Security Basics (Practical)", "7.3 Building Secure by Default"] },
        { title: "Part 8 \u2014 Errors, Testing & Deployment",
          items: ["8.1 From 'Works on My Machine' to Production", "8.2 Error Handling, Testing, and Deploying (Practical)", "8.3 Building Reliable, Maintainable Backends"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Node API", "9.2 The Remote Node Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Fundamentals & Async on One Page", "A.2 Core APIs, Servers & Databases on One Page", "A.3 Security & Production on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "javascript": {
      title: "JavaScript",
      subtitle: "The complete JavaScript training \u2014 foundations, control flow & functions, data structures, modern JavaScript, the DOM, events & forms, async & APIs, and debugging & clean code. Ends in The JavaScript Portfolio. Recommended duration: 5\u20138 weeks.",
      training: "training/javascript/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Foundations", "Variables, types, operators, running JS", "First working scripts"],
        ["1\u20132", "Part 2 \u00b7 Control Flow & Functions", "Conditionals, loops, functions, scope", "Reusable functions"],
        ["2", "Part 3 \u00b7 Data Structures", "Arrays, objects, and their key methods", "Data manipulation"],
        ["2\u20133", "Part 4 \u00b7 Modern JavaScript (ES2015+)", "Arrow fns, destructuring, spread, modules, more", "Clean modern code"],
        ["3\u20134", "Part 5 \u00b7 The DOM & Interactivity", "Selecting, changing, and reacting to the page", "Interactive pages"],
        ["4", "Part 6 \u00b7 Events & Forms", "Event handling, user input, forms, validation", "A working interactive app"],
        ["4\u20135", "Part 7 \u00b7 Async JavaScript & APIs", "Promises, async/await, fetch, working with APIs", "Apps that fetch live data"],
        ["5\u20136", "Part 8 \u00b7 Errors, Debugging & Clean Code", "Error handling, debugging, organising code", "Robust, clean projects"],
        ["6\u20137", "Part 9 \u00b7 Capstone & Career", "The JavaScript Portfolio, the job hunt", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 Why JavaScript Is the Language to Learn", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (5\u20138 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Foundations",
          items: ["1.1 What Programming Is, in JavaScript", "1.2 Variables, Types, and Operators (Practical)", "1.3 Running JavaScript and Building Habits"] },
        { title: "Part 2 \u2014 Control Flow & Functions",
          items: ["2.1 Decisions and Repetition", "2.2 Conditionals, Loops, and Functions (Practical)", "2.3 Functions and Thinking in Reusable Pieces"] },
        { title: "Part 3 \u2014 Data Structures",
          items: ["3.1 Arrays and Objects: How Data Is Organised", "3.2 Arrays, Objects, and Their Methods (Practical)", "3.3 Transforming Data Fluently"] },
        { title: "Part 4 \u2014 Modern JavaScript (ES2015+)",
          items: ["4.1 Why Modern JavaScript Matters", "4.2 The Modern Toolkit (Practical)", "4.3 Writing Clean, Idiomatic Code"] },
        { title: "Part 5 \u2014 The DOM & Interactivity",
          items: ["5.1 The DOM: JavaScript's Power Over the Page", "5.2 Selecting and Changing the Page (Practical)", "5.3 Building Dynamic Interfaces"] },
        { title: "Part 6 \u2014 Events & Forms",
          items: ["6.1 Reacting to the User", "6.2 Event Handling and Forms (Practical)", "6.3 Building Real Interactive Apps"] },
        { title: "Part 7 \u2014 Async JavaScript & APIs",
          items: ["7.1 The Web Is Asynchronous", "7.2 Promises, Async/Await, and Fetch (Practical)", "7.3 Building Real, Dynamic Apps"] },
        { title: "Part 8 \u2014 Errors, Debugging & Clean Code",
          items: ["8.1 Errors and Debugging Are the Job", "8.2 Handling Errors and Debugging (Practical)", "8.3 Writing Code Like a Professional"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The JavaScript Portfolio", "9.2 JavaScript in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Fundamentals & Data on One Page", "A.2 Modern JS & the DOM on One Page", "A.3 Events, Async & Clean Code on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "react": {
      title: "React",
      subtitle: "The complete React training \u2014 thinking in components, props, state & hooks, events & forms, rendering lists & conditionals, effects & data fetching, state management & context, and routing, structure & deployment. Ends in The React App. Recommended duration: 5\u20138 weeks.",
      training: "training/react/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Thinking in React & Setup", "Components, JSX, the React mindset, a project", "A first rendered component"],
        ["1\u20132", "Part 2 \u00b7 Components, JSX & Props", "Building & composing components, passing props", "A composed component tree"],
        ["2", "Part 3 \u00b7 State & the useState Hook", "State, re-rendering, interactivity", "An interactive stateful component"],
        ["2\u20133", "Part 4 \u00b7 Events & Handling Input", "Events, forms, controlled inputs", "Interactive forms"],
        ["3", "Part 5 \u00b7 Rendering Lists & Conditionals", "Lists with keys, conditional rendering", "Dynamic, data-driven UI"],
        ["3\u20134", "Part 6 \u00b7 Effects & Data Fetching", "useEffect, fetching API data, the lifecycle", "An app fetching live data"],
        ["4\u20135", "Part 7 \u00b7 Hooks, State Management & Context", "More hooks, sharing state, custom hooks", "Well-managed app state"],
        ["5", "Part 8 \u00b7 Routing, Structure & Deployment", "Routing, project structure, building & deploying", "A multi-page, deployed app"],
        ["5\u20136", "Part 9 \u00b7 Capstone & Career", "The React App, the portfolio, the job hunt", "A portfolio-ready React app"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What React Is and Why It Dominates", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (5\u20138 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Thinking in React & Setup",
          items: ["1.1 The React Mindset", "1.2 Components and JSX (Practical)", "1.3 Composition: Building UIs from Pieces"] },
        { title: "Part 2 \u2014 Components, JSX & Props",
          items: ["2.1 Props: Passing Data to Components", "2.2 Passing and Using Props (Practical)", "2.3 Designing a Component Tree"] },
        { title: "Part 3 \u2014 State & the useState Hook",
          items: ["3.1 State: Data That Changes", "3.2 The useState Hook (Practical)", "3.3 The Re-Render Cycle and Where State Lives"] },
        { title: "Part 4 \u2014 Events & Handling Input",
          items: ["4.1 Handling Events the React Way", "4.2 Events and Controlled Inputs (Practical)", "4.3 Building Interactive Forms"] },
        { title: "Part 5 \u2014 Rendering Lists & Conditionals",
          items: ["5.1 UI as a Function of Data", "5.2 Mapping Lists and Conditional Rendering (Practical)", "5.3 Dynamic, Data-Driven Interfaces"] },
        { title: "Part 6 \u2014 Effects & Data Fetching",
          items: ["6.1 Side Effects and the Outside World", "6.2 useEffect and Fetching Data (Practical)", "6.3 Building Real, Data-Driven Apps"] },
        { title: "Part 7 \u2014 Hooks, State Management & Context",
          items: ["7.1 Beyond useState: Managing Real App State", "7.2 Context, Hooks, and Custom Hooks (Practical)", "7.3 Clean, Scalable State Management"] },
        { title: "Part 8 \u2014 Routing, Structure & Deployment",
          items: ["8.1 From Components to a Real Application", "8.2 Routing, Structure, and Deploying (Practical)", "8.3 Shipping Complete React Apps"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The React App", "9.2 The Remote React Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Components, JSX & Props on One Page", "A.2 State, Events & Rendering on One Page", "A.3 Effects, State Mgmt & Routing on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "ai-agent-creation": {
      ...
      subtitle: "The complete AI agent-creation training \u2014 agents & the landscape, prompting foundations, tools & function calling, the agent loop, knowledge & memory (RAG), building agents, multi-agent workflows, and guardrails, evaluation & safety. Ends in The Agent Portfolio. Recommended duration: 4\u20136 weeks.",
      training: "training/aiagentcreation/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Agents & the Landscape", "What agents are, the 2026 tools, the role", "An agent concept + the right tool"],
        ["1", "Part 2 \u00b7 LLM & Prompting Foundations", "The model, prompts, structured output for agents", "Agent-ready prompts"],
        ["1\u20132", "Part 3 \u00b7 Tools & Function Calling", "Giving agents tools/actions, tool descriptions", "A tool-using assistant"],
        ["2", "Part 4 \u00b7 The Agent Loop & Reasoning", "Plan-act-observe, ReAct, multi-step reasoning", "A multi-step agent"],
        ["2\u20133", "Part 5 \u00b7 Knowledge & Memory (RAG)", "Grounding agents in data; memory", "A knowledge-grounded agent"],
        ["3", "Part 6 \u00b7 Building Agents (No-Code & Frameworks)", "Agent platforms & frameworks, wiring it together", "A built, working agent"],
        ["3\u20134", "Part 7 \u00b7 Multi-Agent & Workflows", "Multiple agents, orchestration, workflows", "An agent workflow/team"],
        ["4", "Part 8 \u00b7 Guardrails, Evaluation & Safety", "Bounds, human-in-loop, evals, monitoring, safety", "A safe, evaluated agent"],
        ["4\u20135", "Part 9 \u00b7 Capstone & Career", "The Agent Portfolio, the job hunt", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What AI Agent Creation Actually Is (in 2026)", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (4\u20136 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Agents & the Landscape",
          items: ["1.1 From Chatbots to Agents", "1.2 What Agents Can Do (and the 2026 Tools)", "1.3 Designing an Agent (Practical)"] },
        { title: "Part 2 \u2014 LLM & Prompting Foundations",
          items: ["2.1 The Model Is the Agent's Brain", "2.2 Prompting and Structured Output for Agents (Practical)", "2.3 The Prompt Is the Agent"] },
        { title: "Part 3 \u2014 Tools & Function Calling",
          items: ["3.1 Tools: The Agent's Hands", "3.2 Defining and Wiring Tools (Practical)", "3.3 Equipping Agents Well"] },
        { title: "Part 4 \u2014 The Agent Loop & Reasoning",
          items: ["4.1 The Loop That Makes an Agent Autonomous", "4.2 Plan, Act, Observe, Repeat (Practical)", "4.3 Reliable Multi-Step Agents"] },
        { title: "Part 5 \u2014 Knowledge & Memory (RAG)",
          items: ["5.1 Agents Need Real Knowledge", "5.2 RAG and Memory for Agents (Practical)", "5.3 Accurate, Coherent Agents"] },
        { title: "Part 6 \u2014 Building Agents (No-Code & Frameworks)",
          items: ["6.1 Bringing It All Together", "6.2 No-Code and Framework Routes (Practical)", "6.3 Building Real, Working Agents"] },
        { title: "Part 7 \u2014 Multi-Agent & Workflows",
          items: ["7.1 When One Agent Isn't Enough", "7.2 Orchestration and Workflows (Practical)", "7.3 Building Agent Systems"] },
        { title: "Part 8 \u2014 Guardrails, Evaluation & Safety",
          items: ["8.1 Agents Act, So Safety Is Critical", "8.2 Guardrails, Human-in-Loop, and Evaluation (Practical)", "8.3 Responsible, Deployable Agents"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Agent Portfolio", "9.2 The Remote Job Hunt"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Agents & Foundations on One Page", "A.2 Tools & the Loop on One Page", "A.3 Knowledge, Multi-Agent & Safety on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "cloudflare": {
      title: "Cloudflare",
      subtitle: "The complete Cloudflare training \u2014 how the web & Cloudflare work, DNS, CDN & caching, security & protection, rules & configuration, the developer platform (Pages), Workers at the edge, and storage, data & Zero Trust. Ends in The Cloudflare Portfolio. Recommended duration: 4\u20136 weeks.",
      training: "training/cloudflare/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Cloudflare & How the Web Works", "The platform, CDN, edge, the request path", "Account + orientation"],
        ["1", "Part 2 \u00b7 DNS Fundamentals", "DNS records, managing DNS on Cloudflare", "A domain on Cloudflare"],
        ["1\u20132", "Part 3 \u00b7 CDN, Caching & Performance", "Caching, the CDN, speeding sites up", "A faster, cached site"],
        ["2", "Part 4 \u00b7 Security & Protection", "DDoS, WAF, bots, SSL/TLS, rules", "A secured site"],
        ["2\u20133", "Part 5 \u00b7 Rules, Page Rules & Configuration", "Rules engine, redirects, transforms", "Configured behaviour"],
        ["3", "Part 6 \u00b7 The Developer Platform \u2014 Pages", "Deploying sites/apps on Cloudflare Pages", "A deployed site"],
        ["3\u20134", "Part 7 \u00b7 Workers & Serverless at the Edge", "Workers, serverless functions, edge code", "A deployed Worker"],
        ["4", "Part 8 \u00b7 Storage, Data & Zero Trust", "R2, KV, D1, Tunnels, Zero Trust basics", "Data + access setups"],
        ["4\u20135", "Part 9 \u00b7 Capstone & Career", "The Cloudflare Portfolio, the job hunt", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 What Cloudflare Is and Why It Matters", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (4\u20136 Weeks)", "0.4 Set Up Your Free Tools (Practical)"] },
        { title: "Part 1 \u2014 Cloudflare & How the Web Works",
          items: ["1.1 Where Cloudflare Sits", "1.2 The Cloudflare Platform (a Tour)", "1.3 Getting Oriented (Practical)"] },
        { title: "Part 2 \u2014 DNS Fundamentals",
          items: ["2.1 DNS: The Internet's Address Book", "2.2 Managing DNS on Cloudflare (Practical)", "2.3 DNS as the Foundation"] },
        { title: "Part 3 \u2014 CDN, Caching & Performance",
          items: ["3.1 The CDN: Speed from the Edge", "3.2 Caching and Performance (Practical)", "3.3 Delivering Real Performance"] },
        { title: "Part 4 \u2014 Security & Protection",
          items: ["4.1 Security: Cloudflare's Other Core Job", "4.2 DDoS, WAF, Bots, and SSL (Practical)", "4.3 Layered, Sensible Defence"] },
        { title: "Part 5 \u2014 Rules, Page Rules & Configuration",
          items: ["5.1 Controlling Behaviour with Rules", "5.2 Redirects, Cache Rules, and Transforms (Practical)", "5.3 Tailoring Cloudflare to Real Needs"] },
        { title: "Part 6 \u2014 The Developer Platform: Pages",
          items: ["6.1 Cloudflare as a Developer Platform", "6.2 Deploying with Pages (Practical)", "6.3 Modern, Edge-Hosted Deployment"] },
        { title: "Part 7 \u2014 Workers & Serverless at the Edge",
          items: ["7.1 Workers: Your Code at the Edge", "7.2 Writing and Deploying Workers (Practical)", "7.3 Building Real Edge Applications"] },
        { title: "Part 8 \u2014 Storage, Data & Zero Trust",
          items: ["8.1 Data at the Edge and Secure Access", "8.2 R2, KV, D1, and Zero Trust (Practical)", "8.3 The Complete Cloudflare Picture"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Cloudflare Portfolio", "9.2 Cloudflare in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Foundations, DNS & Performance on One Page", "A.2 Security & Rules on One Page", "A.3 The Developer Platform on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "microsoft-office": {
      ...
      subtitle: "The complete Microsoft Office training \u2014 working smart, professional Word documents, Excel foundations, analysis & power functions, PivotTables & dashboards, compelling PowerPoint, Outlook & collaboration, and Copilot & automation. Ends in The Office Portfolio. Recommended duration: 4\u20136 weeks.",
      training: "training/microsoftoffice/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 The Suite & Working Smart", "The apps, the cloud, shortcuts, efficiency", "Set up + a fast workflow"],
        ["1", "Part 2 \u00b7 Word \u2014 Professional Documents", "Formatting, styles, structure, polish", "A professional document"],
        ["1\u20132", "Part 3 \u00b7 Excel Foundations", "Data, formulas, functions, the essentials", "A working spreadsheet"],
        ["2\u20133", "Part 4 \u00b7 Excel \u2014 Analysis & Power Functions", "Lookups, logic, conditional, data tools", "Real data analysis"],
        ["3", "Part 5 \u00b7 Excel \u2014 PivotTables, Charts & Dashboards", "PivotTables, charts, dashboards, insight", "An Excel dashboard"],
        ["3\u20134", "Part 6 \u00b7 PowerPoint \u2014 Compelling Presentations", "Design, structure, delivery, polish", "A strong presentation"],
        ["4", "Part 7 \u00b7 Outlook, Email & Collaboration", "Email, calendar, Teams, M365 collaboration", "Efficient comms & collaboration"],
        ["4\u20135", "Part 8 \u00b7 Automation, Copilot & Advanced", "Templates, Copilot AI, intro to macros", "AI-assisted, automated work"],
        ["5", "Part 9 \u00b7 Capstone & Career", "The Office Portfolio, proving the skill", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 Why Office Skills Still Matter (and Pay)", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (4\u20136 Weeks)", "0.4 Set Up Your Toolkit (Practical)"] },
        { title: "Part 1 \u2014 The Suite & Working Smart",
          items: ["1.1 The Office Suite and How It Fits Together", "1.2 Working Smart: Shortcuts, Cloud, Templates (Practical)", "1.3 The Efficiency Mindset"] },
        { title: "Part 2 \u2014 Word: Professional Documents",
          items: ["2.1 From Typing to Professional Documents", "2.2 Formatting, Styles, and Structure (Practical)", "2.3 Documents That Look and Work Professionally"] },
        { title: "Part 3 \u2014 Excel Foundations",
          items: ["3.1 Why Excel Is the Crown Jewel", "3.2 Data, Formulas, and Essential Functions (Practical)", "3.3 Good Spreadsheets, Built Right"] },
        { title: "Part 4 \u2014 Excel: Analysis & Power Functions",
          items: ["4.1 The Functions That Make Excel Powerful", "4.2 Lookups, Logic, and Conditional Functions (Practical)", "4.3 Doing Real Analysis"] },
        { title: "Part 5 \u2014 Excel: PivotTables, Charts & Dashboards",
          items: ["5.1 From Data to Insight", "5.2 PivotTables, Charts, and Dashboards (Practical)", "5.3 Communicating Insight"] },
        { title: "Part 6 \u2014 PowerPoint: Compelling Presentations",
          items: ["6.1 Beyond Bullet Points", "6.2 Design, Structure, and Polish (Practical)", "6.3 Presentations That Land"] },
        { title: "Part 7 \u2014 Outlook, Email & Collaboration",
          items: ["7.1 Communication and Collaboration Are the Job", "7.2 Email, Calendar, and Teams (Practical)", "7.3 Being an Effective Remote Collaborator"] },
        { title: "Part 8 \u2014 Automation, Copilot & Advanced",
          items: ["8.1 Working Smarter with AI and Automation", "8.2 Copilot, Templates, and Automation (Practical)", "8.3 The Productive, Modern Office User"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Office Portfolio", "9.2 Office Skills in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Working Smart & Word on One Page", "A.2 Excel Essentials & Power on One Page", "A.3 Pivots, PowerPoint, Comms & AI on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "google-workspace": {
      ...
      subtitle: "The complete Google Workspace training \u2014 Drive & collaboration, Docs, Sheets foundations, analysis & power functions, pivot tables & dashboards, Slides, Gmail, Calendar & Meet, and Gemini AI & automation. Ends in The Workspace Portfolio. Recommended duration: 4\u20136 weeks.",
      training: "training/googleworkspace/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Workspace, Drive & Collaboration", "The suite, Drive, sharing, real-time collaboration", "Set up + collaborative working"],
        ["1", "Part 2 \u00b7 Google Docs", "Collaborative documents, formatting, structure", "A professional Doc"],
        ["1\u20132", "Part 3 \u00b7 Sheets Foundations", "Data, formulas, functions, the essentials", "A working spreadsheet"],
        ["2\u20133", "Part 4 \u00b7 Sheets \u2014 Analysis & Power Functions", "Lookups, logic, conditional, Sheets-specials", "Real data analysis"],
        ["3", "Part 5 \u00b7 Sheets \u2014 Pivot Tables, Charts & Dashboards", "Pivot tables, charts, dashboards, insight", "A Sheets dashboard"],
        ["3\u20134", "Part 6 \u00b7 Google Slides", "Compelling, collaborative presentations", "A strong presentation"],
        ["4", "Part 7 \u00b7 Gmail, Calendar & Meet", "Email, calendar, meetings, communication", "Efficient comms"],
        ["4\u20135", "Part 8 \u00b7 AI (Gemini), Automation & Beyond", "Gemini AI, Forms, automation, the wider suite", "AI-assisted, automated work"],
        ["4\u20135", "Part 9 \u00b7 Capstone & Career", "The Workspace Portfolio, proving the skill", "A portfolio + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 Why Google Workspace Skills Matter", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (4\u20136 Weeks)", "0.4 Set Up Your Free Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Workspace, Drive & Collaboration",
          items: ["1.1 The Cloud-Native, Collaboration-First Suite", "1.2 Drive, Sharing, and Collaboration (Practical)", "1.3 Working the Collaborative, Cloud Way"] },
        { title: "Part 2 \u2014 Google Docs",
          items: ["2.1 Collaborative, Professional Documents", "2.2 Formatting, Structure, and Collaboration (Practical)", "2.3 Documents the Team Works On Together"] },
        { title: "Part 3 \u2014 Sheets Foundations",
          items: ["3.1 Why Sheets Is the Power Tool", "3.2 Data, Formulas, and Essential Functions (Practical)", "3.3 Good Spreadsheets, Built Right"] },
        { title: "Part 4 \u2014 Sheets: Analysis & Power Functions",
          items: ["4.1 The Functions That Make Sheets Powerful", "4.2 Lookups, Logic, and Conditional Functions (Practical)", "4.3 Doing Real Analysis"] },
        { title: "Part 5 \u2014 Sheets: Pivot Tables, Charts & Dashboards",
          items: ["5.1 From Data to Shared Insight", "5.2 Pivot Tables, Charts, and Dashboards (Practical)", "5.3 Communicating Insight to the Team"] },
        { title: "Part 6 \u2014 Google Slides",
          items: ["6.1 Compelling, Collaborative Presentations", "6.2 Design, Structure, and Collaboration (Practical)", "6.3 Presentations That Land"] },
        { title: "Part 7 \u2014 Gmail, Calendar & Meet",
          items: ["7.1 Communication and Coordination Are the Job", "7.2 Gmail, Calendar, and Meet (Practical)", "7.3 Being an Effective Remote Collaborator"] },
        { title: "Part 8 \u2014 AI (Gemini), Automation & Beyond",
          items: ["8.1 Working Smarter with AI and the Wider Suite", "8.2 Gemini, Forms, and Automation (Practical)", "8.3 The Productive, Modern Workspace User"] },
        { title: "Part 9 \u2014 Capstone, Portfolio & Career",
          items: ["9.1 THE CAPSTONE: The Workspace Portfolio", "9.2 Workspace Skills in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Collaboration & Docs on One Page", "A.2 Sheets Essentials & Power on One Page", "A.3 Pivots, Slides, Gmail & Gemini on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
    "time-management": {
      ...
      subtitle: "The complete time-management & productivity training \u2014 where your time goes, goals & priorities, capturing & organising tasks, planning, focus & beating distraction, beating procrastination, habits & routines, and energy, balance & avoiding burnout. Ends in Your Productivity System. Recommended duration: 3\u20135 weeks.",
      training: "training/timemanagement/index.html",
      roadmap: [
        ["1", "Part 1 \u00b7 Where Your Time Goes", "Awareness, audit, your patterns & leaks", "A clear picture of your time"],
        ["1", "Part 2 \u00b7 Goals & Priorities", "Goals, what matters, prioritisation", "Clear priorities"],
        ["1\u20132", "Part 3 \u00b7 Capturing & Organising Tasks", "A trusted system to capture & organise everything", "A working task system"],
        ["2", "Part 4 \u00b7 Planning Your Days & Weeks", "Daily/weekly planning, time blocking", "A planned week"],
        ["2\u20133", "Part 5 \u00b7 Focus & Beating Distraction", "Deep work, attention, killing distractions", "Sustained focus"],
        ["3", "Part 6 \u00b7 Beating Procrastination", "Why we procrastinate, and how to start", "Reliable execution"],
        ["3\u20134", "Part 7 \u00b7 Habits, Systems & Routines", "Building habits & routines that run on autopilot", "Productive routines"],
        ["4", "Part 8 \u00b7 Energy, Balance & Avoiding Burnout", "Energy management, boundaries, sustainable pace", "Sustainable productivity"],
        ["4\u20135", "Part 9 \u00b7 Your System & Beyond", "Your Productivity System, making it stick", "A personal system + a plan"]
      ],
      modules: [
        { title: "Part 0 \u2014 Start Here: How This Guide Works",
          items: ["0.1 Why Time Management Is the Meta-Skill", "0.2 The Golden Rules", "0.3 The Recommended Roadmap (3\u20135 Weeks)", "0.4 Set Up Your Simple Toolkit (Practical)"] },
        { title: "Part 1 \u2014 Where Your Time Goes",
          items: ["1.1 Awareness Comes First", "1.2 Auditing Your Time and Patterns (Practical)", "1.3 From Awareness to Intention"] },
        { title: "Part 2 \u2014 Goals & Priorities",
          items: ["2.1 Effectiveness Before Efficiency", "2.2 Goals and Prioritisation (Practical)", "2.3 Focusing on What Matters"] },
        { title: "Part 3 \u2014 Capturing & Organising Tasks",
          items: ["3.1 Your Head Is a Bad To-Do List", "3.2 Capturing and Organising (Practical)", "3.3 A Clear Mind and a Handle on Everything"] },
        { title: "Part 4 \u2014 Planning Your Days & Weeks",
          items: ["4.1 A Plan Turns Intention into Action", "4.2 Daily/Weekly Planning and Time Blocking (Practical)", "4.3 Proactive, Not Reactive"] },
        { title: "Part 5 \u2014 Focus & Beating Distraction",
          items: ["5.1 Attention Is the Scarce Resource", "5.2 Deep Work and Killing Distraction (Practical)", "5.3 The Ability to Focus Deeply"] },
        { title: "Part 6 \u2014 Beating Procrastination",
          items: ["6.1 Why We Procrastinate", "6.2 Techniques to Just Start (Practical)", "6.3 Reliable Execution"] },
        { title: "Part 7 \u2014 Habits, Systems & Routines",
          items: ["7.1 Systems Beat Willpower", "7.2 Building Habits and Routines (Practical)", "7.3 Productivity on Autopilot"] },
        { title: "Part 8 \u2014 Energy, Balance & Avoiding Burnout",
          items: ["8.1 Manage Energy, Not Just Time", "8.2 Energy, Boundaries, and Balance (Practical)", "8.3 Productivity That Lasts"] },
        { title: "Part 9 \u2014 Your System & Beyond",
          items: ["9.1 THE CAPSTONE: Your Productivity System", "9.2 Self-Management in Your Remote Career"] },
        { title: "Appendix A \u2014 Quick-Reference Cheat Sheets",
          items: ["A.1 Awareness, Priorities & Planning on One Page", "A.2 Focus & Procrastination on One Page", "A.3 Habits & Sustainability on One Page"] },
        { title: "Appendix B \u2014 The Recommended Daily Study Plan",
          items: ["B.1 The Plan"] }
      ]
    },
  ...
  var BACKEND_URL = "";   // e.g. "https://script.google.com/macros/s/AKfy.../exec"
  var BACKEND_SECRET = "CHANGE-ME-to-a-long-random-string-9f3b2";  // must match Code.gs
